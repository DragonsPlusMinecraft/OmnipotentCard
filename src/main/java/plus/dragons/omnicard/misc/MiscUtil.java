...
public class MiscUtil {
    ...
    public static BlockPos getBlockRandomPos(int x, int y, int z, int radius, RandomSource random) {
        return getBlockRandomPos(x, y, z, radius, radius, random);
    }

    public static BlockPos getBlockRandomPos(int x, int y, int z, int width, int height, RandomSource random) {
    ...
    public static MutableComponent tooltip(String id, TextColor color) {
        return Component.translatable(id).setStyle(Style.EMPTY.withColor(color).withBold(false));
    }

    public static MutableComponent tooltipBold(String id, TextColor color) {
        return Component.translatable(id).setStyle(Style.EMPTY.withColor(color).withBold(true));
    }
